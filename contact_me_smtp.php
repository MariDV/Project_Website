...
if($_POST)
{
    $to_Email       = "mariana@eternalskincare.ca"; // Replace with recipient email address
	$subject        = 'Message from website '.$_SERVER['SERVER_NAME']; //Subject line for emails
    
    $host           = "secure.emailsrvr.com"; // Your SMTP server. For example, smtp.mail.yahoo.com
    $username       = "mariana@eternalskincare.ca"; //For example, your.email@yahoo.com
    $password       = "Vilela1234"; // Your password
